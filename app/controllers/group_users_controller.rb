class GroupUsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group_user.save
        format.html { redirect_to groups_path, notice: "You have joined the group!" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to groups_path, notice: "You have left the group!", status: :see_other }
