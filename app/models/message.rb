class Message < ApplicationRecord
  ...
  def broadcast_update
    ...
    broadcast_update_later_to("group_#{group_id}", partial: "groups/group_preview", locals: { group:  group, current_user: user }, target: "group_#{group_id}")
    ...
    broadcast_append_later_to("group_#{group_id}", partial: "messages/message", locals: { message: self, current_user: user}, target: "messages")
  end
